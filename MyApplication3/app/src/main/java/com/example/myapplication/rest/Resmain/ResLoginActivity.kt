...
import com.example.myapplication.start.FindEmail
import com.example.myapplication.start.FindPassword
                    ...
                    if(task.isSuccessful()) {
                        ...
                        val loginEventListener = object : ValueEventListener {
                            override fun onDataChange(snapshot: DataSnapshot) {
                                var intent = Intent(
                                        this@ResLoginActivity,
                                        ChoiceSikdangPage_res::class.java
                                )
